...
{
    public class AstraeusAntiMat : ModItem//Astraeus is the greek god of the stars
        //This weapon is a shotgun that fires slow moving explosive lasers of doom that do enourmous damage.  It does the most single target damage of the superweapons
        //I am planning on adding a right click attack that summons a massive meteor from the sky
