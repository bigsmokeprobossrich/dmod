...
{
	public class HadesBolt3 : ModProjectile//The third hades bullet
		//This one inflicts a bunch of debuffs and makes enemies drop more money, although I have never actually seted if the mone dropping part works
	{
