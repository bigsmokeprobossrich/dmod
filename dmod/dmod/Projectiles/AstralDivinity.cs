...
{
	public class AstralDivinity : ModProjectile//The lasers that Astraeus fires
		//The name is a reference to a cool geometry dash level that in turn references Calamity
	{
		...
		public override void Kill(int timeLeft)//That Big Beautiful Explosion
		{
